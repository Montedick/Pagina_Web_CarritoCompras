		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">Formulario para registrar al cliente</div>
					...
					<form id="signup_form" onsubmit="return false">
						...
						<div class="row">
							<div class="col-md-12">
								<label for="address1">Direccion opcion 1</label>
								<input type="text" id="address1" name="address1"class="form-control">
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<label for="address2">Direccion opcion 2</label>
						...
						<div class="row">
							<div class="col-md-12">
								<input style="width:100%;" value="Iniciar a comprar..." type="submit" name="signup_button" class="btn btn-success btn-lg">
							</div>
						</div>
